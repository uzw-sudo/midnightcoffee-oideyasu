...
(() => {
  const STAGES = [
    { id: "bud", name: "蕾", duration: 2600, density: 14, length: 28, speed: .95, dialogue: "火がついたなぁ。……最初は、まだ小さな蕾だ。" },
    { id: "peony", name: "牡丹", duration: 3000, density: 28, length: 48, speed: 1.45, dialogue: "お。牡丹になった。……慌てず見てろよ。" },
    { id: "pine", name: "松葉", duration: 3600, density: 48, length: 72, speed: 2.2, dialogue: "いちばん賑やかなところだぁ。願い事、忘れてないか？" },
    { id: "chrysanthemum", name: "散り菊", duration: 3200, density: 22, length: 42, speed: .72, dialogue: "もうすぐ終わる。……最後まで見届けてやれ。" }
  ];

  const RESULTS = [
    { name:"牡丹", subtitle:"小さな喜びがひらく夜", rarity:"NORMAL", color:"琥珀色", word:"ほどける", message:"今夜の花火は、ぱっと明るく開く牡丹。\n大きな変化より、すぐそばにある小さな喜びを見つけられる夜です。", master:"「いい顔してたぞ。……そのくらいで十分だぁ。」" },
    { name:"松葉", subtitle:"一歩を踏み出す夜", rarity:"NORMAL", color:"金緑色", word:"進む", message:"細く鋭い火花が、迷いを切り分ける松葉。\n決め切れなかったことへ、明日は小さな一歩を置けそうです。", master:"「全部決めなくていい。ひとつだけ動かせばいいだろぉ？」" },
    { name:"散り菊", subtitle:"手放して眠る夜", rarity:"NORMAL", color:"淡金色", word:"休む", message:"静かにほどけて落ちる散り菊。\n今日抱えていたものを、今夜だけは床へ置いても構いません。", master:"「持ったまま寝ると、朝まで疲れるぞ。置いてけ。」" },
    { name:"月雫", subtitle:"心をやわらかくする夜", rarity:"RARE", color:"月白色", word:"やさしく", message:"月明かりを含んだような、淡い雫の火花。\n自分へ向ける言葉を、誰かへ向けるときと同じくらい優しくしてください。", master:"「自分にだけ厳しいの、そろそろやめたらどうだぁ？」" },
    { name:"星結び", subtitle:"縁が静かにつながる夜", rarity:"RARE", color:"青金色", word:"つながる", message:"離れた火花が一瞬だけ線を結ぶ星結び。\n忘れていた人や言葉が、近いうちに穏やかな形で戻ってきそうです。", master:"「会いたいなら、会いたいって言えばいい。難しくすんなぁ。」" },
